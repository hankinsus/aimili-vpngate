...
| **静态机房住宅IP** | 想低成本跨境电商、流媒体解锁、直播等住宅IP需求的用户 | **不限流量**，价格实惠、经过1个月测试，可入手试试，| [立即查看](https://www.miyaip.com/?invitecode=2955039) |
...
#### 🌟 正式稳定版本 (main 分支)
```bash
bash <(curl -Ls https://raw.githubusercontent.com/hankinsus/aimili-vpngate/refs/heads/main/install.sh)
```
